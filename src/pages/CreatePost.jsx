  ...
  const generateImage = async () => {
    if(form.prompt) {
      try {
        ...
        const response = await fetch('https://dalle-backend-981r.onrender.com/api/v1/dalle', {
          method: 'POST',
          headers: {
    ...
    <section className='max-w-7xl mx-auto'>
      <div className=''>
            ...
            <p className="mt-2 text-[#666e75] text-[16px] max-w[500px]">
                Create imaginative and visually stunning images through by DALL-E AI and shared them with community.
            </p>
        </div>
            ...
            <form className='mt-16 max-w-6xl' onSubmit={handleSubmit}>
              ...
              <div className='mt-10'>
                  <p className='mt-2 text-[#666e75] text-[14px]'>
                    ** Once you have created the image you wnat, you can shre it with others in the community. **
                  </p>
                  <button
                    type='submit'
